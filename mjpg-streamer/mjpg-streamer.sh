#!/bin/bash
# Script and code from http://www.bobtech.ro/tutoriale/raspberry-pi/78-streaming-webcam-in-format-m-jpg-cu-raspberry-pi
# (c) Calin Crisan
...
function start() {
	...
	echo "Running with input options ${INPUT_OPTIONS}"
	echo "Running with output options ${OUTPUT_OPTIONS}"
